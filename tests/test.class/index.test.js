...
const { test_post_fruta_descompuesta, test_get_fruta_descompuesta } = require("./frutaDescompuesta.test");
...
(
    async () => {
        ...
        try {
            ...
            await test_post_fruta_descompuesta();
            await test_get_fruta_descompuesta();
